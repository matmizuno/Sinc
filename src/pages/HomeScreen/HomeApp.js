...
export default function HomeApp() {
  ...
  // Função para carregar o nome de usuário
  ...
  // Função para inicializar os saldos
  ...
  // Funções para comprar e vender moedas
  ...
  useEffect(() => {
    const initializeApp = async () => {
      await loadUsername(); // Carrega o nome de usuário
      await loadSaldos();  // Carrega os saldos
  ...
  return (
    <View style={style.tudo}>
      <View style={style.cabecalho}></View>
